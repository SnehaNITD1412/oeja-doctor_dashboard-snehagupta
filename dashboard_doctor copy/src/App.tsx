...
import AddSchedule from "./pages/Schedule/AddSchedule.tsx";
import ViewSchedule from "./pages/Schedule/ViewSchedule";
import ReportSection from "./pages/Reports/ReportSection";
...
<Route path="/reports" element={<ReportSection />} />
      ...
      <Route path="/prescriptions/view" element={<ViewPrescriptions />} />
